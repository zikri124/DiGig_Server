create table `users`( id integer primary key auto_increment, name varchar(40), gender varchar(5), birthday date, address varchar(50), email varchar(40), hashedPassword varchar(50), identCard varchar(50), phoneNum varchar(15), photoProfile varchar(50), createdAt timestamp default CURRENT_TIMESTAMP )
